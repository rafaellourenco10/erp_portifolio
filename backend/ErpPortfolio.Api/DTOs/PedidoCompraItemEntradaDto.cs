// =====================================================================================
// Arquivo....: PedidoCompraItemEntradaDto.cs
// Versão.....: 1.0.0
// Data.......: 22/09/2026
// Descrição..: DTO de entrada de um item do pedido de compra (dentro do corpo de POST/PUT
//              /api/pedidos-compra): produto, quantidade e desconto do item. O preço
//              unitário NÃO é enviado: o servidor o copia do Custo do produto (PC2 da
//              SPEC.md). Espelho de PedidoItemEntradaDto.
// -------------------------------------------------------------------------------------
// Banco......: Não acessa banco diretamente.
// Tabelas....: Os dados são gravados em public.pedido_compra_itens pelo PedidoCompraService.
...
public class PedidoCompraItemEntradaDto : IValidatableObject
{
    /// <example>5</example>
