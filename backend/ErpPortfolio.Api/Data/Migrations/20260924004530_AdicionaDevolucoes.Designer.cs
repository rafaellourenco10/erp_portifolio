...
namespace ErpPortfolio.Api.Data.Migrations
{
    ...
    [Migration("20260924004530_AdicionaDevolucoes")]
    partial class AdicionaDevolucoes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpPortfolio.Api.Models.Comissao", b =>
                {
                    ...
                    b.HasIndex("DevolucaoId")
                        .HasDatabaseName("ix_comissoes_devolucao_id");
                    ...
                    b.ToTable("comissoes", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_comissoes_valor", "(parcela_receber_id IS NOT NULL AND devolucao_id IS NULL AND valor > 0) OR (parcela_receber_id IS NULL AND devolucao_id IS NOT NULL AND valor < 0)");
                        });
                });

            modelBuilder.Entity("ErpPortfolio.Api.Models.Devolucao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("devolucoes", null, t =>
                        {
                            t.HasCheckConstraint("ck_devolucoes_valores", "valor_total > 0 AND valor_abatido >= 0 AND valor_reembolso >= 0 AND valor_total = valor_abatido + valor_reembolso");
                        });
                });

            modelBuilder.Entity("ErpPortfolio.Api.Models.DevolucaoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_devolucao_itens");

                    b.HasIndex("PedidoItemId")
                        .HasDatabaseName("ix_devolucao_itens_pedido_item_id");

                    b.HasIndex("DevolucaoId", "PedidoItemId")
                        .IsUnique()
                        .HasDatabaseName("ux_devolucao_itens_devolucao_item");

                    b.ToTable("devolucao_itens", null, t =>
                        {
                            t.HasCheckConstraint("ck_devolucao_itens_quantidade", "quantidade > 0");

                            t.HasCheckConstraint("ck_devolucao_itens_valor", "valor >= 0");
                        });
                });
                    ...
                    b.ToTable("parcelas_pagar", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_parcelas_pagar_origem", "(origem = 'Compra' AND pedido_compra_id IS NOT NULL) OR (origem = 'Comissao' AND vendedor_id IS NOT NULL) OR (origem = 'Avulsa' AND descricao IS NOT NULL) OR (origem = 'Devolucao' AND devolucao_id IS NOT NULL)");
            ...
            modelBuilder.Entity("ErpPortfolio.Api.Models.Comissao", b =>
                {
                    b.HasOne("ErpPortfolio.Api.Models.Devolucao", "Devolucao")
                        .WithMany()
            ...
            modelBuilder.Entity("ErpPortfolio.Api.Models.DevolucaoItem", b =>
                {
                    ...
                    b.HasOne("ErpPortfolio.Api.Models.PedidoItem", "PedidoItem")
                        .WithMany()
